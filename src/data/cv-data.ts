// CV Data for Augusto Espinel Porras
...
export const personalInfo = {
    ...
    contact: {
        ...
        linkedin: "https://linkedin.com/in/aespinel",
        github: "https://github.com/augusto-espinel",
        substack: "https://substack.com/@epsilen?r=g7rm5&utm_campaign=profile&utm_medium=profile-page",
        youtube: "https://youtube.com/playlist?list=PLtXGF3Fy4Q_oOSvaaFaBHcgxSW7pRGcGM&si=X-4IC0uubu3yBeai"
    },
    summary: `Creative and highly motivated, with an open, and collaborative mindset and fluency in various international contexts.
...
export const education = [
    {
        ...
        degree: "MSc in Energy Science & Technology",
        location: "Zurich, Switzerland",
        period: "Sept 2009 – Oct 2011",
        highlights: [
            "Recipient of the Excellence Scholarship and Opportunity Award (CHF 31,500) based on academic achievements and battery aging research proposal.",
            "Master Thesis: Predictive Energy Management Strategies for Electric Vehicles."
        ]
    },
    {
        institution: "University of California Los Angeles (UCLA Extension)",
        degree: "Certificate in Project Management & Embedded Systems Design",
    ...
    },
    {
        ...
        period: "Jan 2001 – Aug 2006",
        highlights: [
            "Thesis: Supervisory Control and Data Acquisition System for Crude Oil Extraction Equipment.",
            "Teacher's assistant for Computer Programming, Signal Analysis, and Electronic Circuits I."
        ]
    }
];
...
export const experience = [
    {
        company: "Alstom (formerly Bombardier Transportation)",
        role: "Traction System Engineer and Energy Efficiency Expert",
        location: "Zurich, Switzerland",
    ...
    },
    {
        ...
        role: "Systems Engineer - Locomotives",
        location: "Zurich, Switzerland",
    ...
    {
        company: "TIG/m LLC",
        role: "Independent Consulting - Systems and Safety Engineering",
        location: "Zurich, Switzerland / Los Angeles, USA",
        period: "Oct 2008 – Dec 2011 (3 years 3 months)",
        responsibilities: [
            "Led compliance efforts to demostrate compliancewith European railway safety standards (EN50126, EN50128, EN50129) via the V-model.",
            "Conducted safety case documentation, FMECA, and Monte Carlo simulations for safety-critical functions in battery-powered streetcars."
        ]
    },
    {
        company: "GE Global Research",
        role: "Intern & Master Thesis Student",
    ...
    },
    {
        ...
        location: "Los Angeles, USA",
        period: "Oct 2006 – Oct 2008 (2 years 1 month)",
        responsibilities: [
            "Served as Electronic Engineer in a 20-person startup, managing the design, development, and testing of power distribution, energy management, and vehicle control systems for battery-powered light-rail vehicles.",
            "Designed an in-house, low-cost battery management system (BMS) for 140kWh LiFePo battery packs, including hardware design, firmware development, and integration with vehicle control systems and HMI."
        ]
    },
    {
        company: "Occidental Petroleum Inc.",
        role: "SCADA Intern",
...
export const publications = [
    {
        title: "Well-to-Wheel Costs, Primary Energy Demand, and Greenhouse Gas Emissions for the Production and Operation of Conventional and Alternative Vehicles",
        authors: "Mashael Yazdanie, Augusto Espinel, et al.",
        date: "Oct 2016",
        publication: "Journal of Transportation Research"
    }
];

export const patents = [
    {
        title: "System and Method for Energy Management in an Electric Vehicle",
        number: "US Patent 2013/0138,279",
        date: "2013"
    }
];
...
export const personalInterests = [
    "Travel (mainly in Africa, Asia and Europe)",
    "Rock Climbing",
    "Hiking",
    "Scuba Diving",
    "Snowboarding",
    "3D Printing (Prusa/FreeCAD)"
];
